...
Top_10_RB_Targets <- Outlier_Free_RB_Rankings |>
  ...
  cols_label(Rank = "Rank", player_name = "Player", possession_team = "Team", 
             average_route_separation = "Average Route Separation")
...
Teams_Ranked <- Ranked_Teams_In_Percentage |>
  distinct(ARS_Rank, possession_team, average_route_separation, Screen_Rank, Screen_Percentage,
           Angle_Rank, Angle_Percentage, Flat_Rank, Flat_Percentage, In_Rank, In_Percentage) |>
  arrange(desc(average_route_separation)) |>
  gt() |> 
  tab_header(title = "Team Rankings by Route Concept",
             subtitle = "Based on Average Route Separation in the 2023 NFL Season") |>
  gt_color_rows(columns = c("average_route_separation"), palette = c("red", "green"), 
                domain = Ranked_Teams_In_Percentage$average_route_separation) |>
  cols_label(ARS_Rank = "ARS Rank", possession_team = "Team", 
             average_route_separation = "Average ARS", Screen_Rank = "Screen Rank",
             Screen_Percentage = "Percent Screens", Angle_Rank = "Angle Rank",
             Angle_Percentage = "Percent Angles", Flat_Rank = "Flat Rank", 
             Flat_Percentage = "Percent Flats", In_Rank = "In Rank", 
             In_Percentage = "Percent Ins") 
...
Route_Averages_Table <- Route_Averages |>
  ...
  gt() |>
  tab_header(title = "Average Route Separation by Route Type",
  ...
  cols_label(Route = "Route", AverageRouteSeparation = "Average Route Separation")
...
Coverage_Averages_Table <- Coverage_Averages |>
  arrange(desc(AverageRouteSeparation)) |>
  gt() |>
  tab_header(title = "Average Route Separation by Coverage Type",
             subtitle = "Using Data from the 2023 NFL Season") |>
  gt_color_rows(columns = c("AverageRouteSeparation"), palette = c("red", "green"), 
                domain = Coverage_Averages$AverageRouteSeparation) |>
  cols_label(Coverage = "Coverage", AverageRouteSeparation = "Average Route Separation")
...
Position_Averages_Table <- Position_Averages |>
  arrange(desc(AverageRouteSeparation)) |>
  gt() |>
  tab_header(title = "Average Route Separation by Position",
             subtitle = "Using Data from the 2023 NFL Season") |>
  gt_color_rows(columns = c("AverageRouteSeparation"), palette = c("red", "green"), 
                domain = Position_Averages$AverageRouteSeparation) |>
  cols_label(Position = "Position", AverageRouteSeparation = "Average Route Separation")
